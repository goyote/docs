...
<p><strong class="caution">Caution:</strong> <code>is_assoc()</code>'s current implementation is very weak, in that it only accepts arrays as arguments, as anything else will throw a fatal error. This goes against PHP's philosophy, imagine how retarded it would be if <code><a href="http://php.net/is_string">is_string()</a></code> only accepted strings as arguments? Ticket <a href="http://dev.kohanaframework.org/issues/3761">#3761</a>.</p>
